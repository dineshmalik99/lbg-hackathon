...
@Component
public class MessageHandlerSMS {
    private final SMSService smsService;
    @Autowired
    public MessageHandlerSMS(SMSService smsService, PushNotificationService pushService) {
        this.smsService = smsService;}

    @PubSubListener(subscription = "sms-sub")
    public void handle(String receivedMessage) {
        System.out.println("Received via @PubSubListener type SMS: " + receivedMessage);
